...
export const THMPreSecurityCertification = () => {
  return (
      ...
      <div className="p-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-300 leading-relaxed text-sm">
            Parcours d'introduction aux prérequis de la cybersécurité : 
            fonctionnement des réseaux, bases Linux et Windows, concepts de sécurité.
          </p>
          ...
          <div className="bg-[#2a2a2f] p-4 rounded-lg">
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>Modèle OSI et TCP/IP</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-3 h-3 text-[#9FEF00] mt-0.5" />
                <span>Fondamentaux Linux</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-3 h-3 text-[#9FEF00] mt-0.5" />
                <span>Fondamentaux Windows</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-3 h-3 text-[#9FEF00] mt-0.5" />
                <span>Concepts de sécurité de base</span>
              </li>
            </ul>
          </div>
        </div>
